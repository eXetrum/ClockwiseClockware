...
module.exports = {
	async up (queryInterface, Sequelize) {
		...
		*/
		...
		let oneYearFromNow = new Date(dateToNearestHour(now.getTime()));
		oneYearFromNow.setFullYear(oneYearFromNow.getFullYear() + 1);
		
		let pattern = [
			{
				clientEmail: 'client1dp@dp.ua', watchName: 'Маленький', cityName: 'Дніпро', masterEmail: 'master1@dp.ua', 
				startDate: oneYearFromNow,
				endDate: null
			}, 
			{
				clientEmail: 'client1dp@dp.ua', watchName: 'Середній', cityName: 'Ужгород', masterEmail: 'master1@dp.ua', 
				startDate: addHours(oneYearFromNow, +5),
				endDate: null
			}, 
			{
				clientEmail: 'client2dp@dp.ua', watchName: 'Середній', cityName: 'Дніпро', masterEmail: 'master2@dp.ua', 
				startDate: oneYearFromNow,
				endDate: null
			},
			{
				clientEmail: 'client1uz@uz.ua', watchName: 'Великий', cityName: 'Ужгород', masterEmail: 'master1@uz.ua', 
				startDate: oneYearFromNow,
				endDate: null
			}
		];
