export { watchSlice } from './WatchSlice';
export { citySlice } from './CitySlice';
export { masterSlice } from './MasterSlice';
export { clientSlice } from './ClientSlice';
export { orderSlice } from './OrderSlice';

export { default as watchReducer } from './WatchSlice';
export { default as cityReducer } from './CitySlice';
export { default as masterReducer } from './MasterSlice';
